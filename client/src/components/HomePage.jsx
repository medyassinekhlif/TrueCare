...
import jumbotron from "../assets/family.png";
          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-6">
              <div className="lg:max-w-lg">
                <p className="text-base font-semibold leading-7 text-[#2A5A7A]">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  ...
                  solution. TrueCare AI leverages cutting-edge machine learning
            ...
            <div className="lg:pr-6">
              <div className="max-w-xl text-base leading-7 text-gray-600 lg:max-w-lg">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 mb-10">
                  <div>
                    <p className="text-3xl font-bold text-[#2A5A7A]">200+</p>
                    <p className="text-gray-600 text-xs font-medium">
                      Insurers Partnered
                    </p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-[#007A7A]">7500+</p>
                    <p className="text-gray-600 text-xs font-medium">
                      Doctors Connected
                    </p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-[#4A5A9A]">92%</p>
                    <p className="text-gray-600 text-xs font-medium">
                      ML Efficiency
                    </p>
                  </div>
                ...
                <ul role="list" className="text-gray-600 space-y-5">
                  <li className="flex gap-x-4">
                    <FaLightbulb
                      className="mt-1 h-5 w-5 flex-none text-[#2A5A7A]"
                      aria-hidden="true"
                    />
                    <span>
                ...
                <div className="mt-10 flex gap-4">
                  <a
                    ...
                    className="rounded-md bg-[#006A6A] px-5 py-2.5 text-sm font-semibold text-white shadow-md hover:bg-[#008080] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#008080] transition-all duration-200"
                  >
                    Doctor Portal
                  </a>
                  <a
                    href="http://localhost:5173/insurer/login"
                    className="rounded-md bg-[#3A4A8A] px-5 py-2.5 text-sm font-semibold text-white shadow-md hover:bg-[#4A5A9A] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4A5A9A] transition-all duration-200"
                  >
                    Insurer Portal
                  </a>
                </div>
